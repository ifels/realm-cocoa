...
class SwiftSyncTestCase: RLMSyncTestCase {
    ...
    func basicCredentials(register: Bool, file: StaticString = #file, line: UInt = #line) -> SyncCredentials {
        return .usernamePassword(username: "\(file)\(line)", password: "a", register: register)
    }
...
class SwiftSyncTestCase: RLMSyncTestCase {
    ...
    func basicCredentials(register register: Bool, file: StaticString = #file, line: UInt = #line) -> SyncCredentials {
        return .usernamePassword("\(file)\(line)", password: "a", register: register)
    }
